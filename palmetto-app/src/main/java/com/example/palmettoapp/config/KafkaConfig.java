package com.example.palmettoapp.config;

import com.example.palmettoapp.property.KafkaConsumerProperties;
import com.example.palmettoapp.property.KafkaProducerProperties;
...
public class KafkaConfig {
  ...
  public ConsumerFactory<String, OrderDto> consumerFactory() {
    final JsonDeserializer<OrderDto> jsonDeserializer = new JsonDeserializer<>();
